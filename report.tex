...
\chapter{Association Schemes}\label{ch:AS}
  ...
  \section{Automorphisms and Cayley Graphs}
    ...
    \begin{proof}
      ...
      and since $G \cong G^*$ (Theorem \ref{thm:character-duality}) implies that the character table is square,
  ...
  \section{Partitions and Translation Schemes}\label{sec:AS:translation}
    ...
    \begin{proof}
      ...
      and let
      \begin{equation}\label{eqn:part-mat-sigma}
        \chi(\sigma) =
        \begin{bmatrix}
...
\chapter{Linear Algebra}
  ...
  algebra; for example, see \cite{fis}.
  \\
