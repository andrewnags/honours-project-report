...
\chapter{Linear Algebra}
  ...
  \section{Positive Semi-Definite Matrices}
    ...
    \begin{defn}
      A real, symmetric matrix $M$ is \textsc{positive semi-definite} if for all
      vectors $x$,
      $$
        x^T M x \geq 0 \ .
      $$
    ...
    \begin{thm}
      ...
      \begin{itemize}
        \item The matrix $M$ is positive semi-definite.
        \item There exists a (possibly non-square) matrix $B$ such that $M = B^T
          B$.
