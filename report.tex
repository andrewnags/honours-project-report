  ...
  \section{Coding Theory}\label{sec:intro:coding}
    ...
    \begin{figure}[h]
      ...
      \begin{tikzpicture}
        ...
        \node[box] (M1) at (-6.5, 0) {message};
        \node[box] (E1) at (-2.8, 0) {encoded};
        \node[box] (E2) at ( 1.5, 0) {encoded + error};
        \node[box] (M2) at ( 6, 0) {message};
        \node[box] (M3) at ( 6,-2) {corrupt};
        \node    (chan) at (-0.8, 0) {};
        \node   (noise) at (-0.8,-2) {};

        \draw[->, thick] (M1) edge[above] node{encoding} (E1);
        \draw[->, thick] (E2) edge[above] node{decoding} (M2);
        \draw[->, thick] (E2) edge[below left] node{decoding failure} (M3);
        \draw[->,decorate, decoration=snake]
          (noise) -- node[left=0.25cm]{noise} (chan);
        \draw[->,decorate, decoration=snake]
          (E1) -- node[above=0.25cm]{transmission} (E2);
      \end{tikzpicture}
  ...
  \section{Linear Codes and Distance-Regular
    ...
    \begin{figure}[h]
      \begin{tikzpicture}
        ...
        \node[dot                        ] (000-0) {};
        \node[dot, right of = 000-0      ] (001-0) {};
        \node[dot, above of = 000-0      ] (010-0) {};
        \node[dot, right of = 010-0      ] (011-0) {};
        \node[dot, above right of = 000-0] (100-0) {};
        \node[dot, right of = 100-0      ] (101-0) {};
        \node[dot, above of = 100-0      ] (110-0) {};
        \node[dot, right of = 110-0      ] (111-0) {};
        \draw[-]
          (000-0) edge[loop] (000-0)
          (001-0) edge[loop] (001-0)
          (010-0) edge[loop] (010-0)
          (011-0) edge[loop] (011-0)
          (100-0) edge[loop] (100-0)
          (101-0) edge[loop] (101-0)
          (110-0) edge[loop] (110-0)
          (111-0) edge[loop] (111-0)
        ;

        \node[dot, label=below:{$000$}, below right of = 101-0] (000-1) {};
        \node[dot, label=below:{$001$}, right of = 000-1      ] (001-1) {};
        \node[dot, label=below:{$010$}, above of = 000-1      ] (010-1) {};
        \node[dot, label=below:{$011$}, right of = 010-1      ] (011-1) {};
        \node[dot, label=below:{$100$}, above right of = 000-1] (100-1) {};
        \node[dot, label=below:{$101$}, right of = 100-1      ] (101-1) {};
        \node[dot, label=below:{$110$}, above of = 100-1      ] (110-1) {};
        \node[dot, label=below:{$111$}, right of = 110-1      ] (111-1) {};
        \draw[-]
          (001-1) edge (101-1)
          (010-1) edge (011-1)
          (010-1) edge (110-1)
        ...
        \node[dot, below right of = 101-1] (000-2) {};
        \node[dot, right of = 000-2      ] (001-2) {};
        \node[dot, above of = 000-2      ] (010-2) {};
        \node[dot, right of = 010-2      ] (011-2) {};
        \node[dot, above right of = 000-2] (100-2) {};
        \node[dot, right of = 100-2      ] (101-2) {};
        \node[dot, above of = 100-2      ] (110-2) {};
        \node[dot, right of = 110-2      ] (111-2) {};
        \draw[-]
          (000-2) edge (011-2)
          (000-2) edge (101-2)
          (000-2) edge (110-2)
        ...
        \node[dot, below right of = 101-2] (000-3) {};
        \node[dot, right of = 000-3      ] (001-3) {};
        \node[dot, above of = 000-3      ] (010-3) {};
        \node[dot, right of = 010-3      ] (011-3) {};
        \node[dot, above right of = 000-3] (100-3) {};
        \node[dot, right of = 100-3      ] (101-3) {};
        \node[dot, above of = 100-3      ] (110-3) {};
        \node[dot, right of = 110-3      ] (111-3) {};
        \draw[-]
          (000-3) edge (111-3)
          (001-3) edge (110-3)
          (010-3) edge (101-3)
  ...
  \section{Hamming Graphs}\label{sec:intro:hamming}
    ...
    \begin{figure}[h]
      ...
      \begin{tikzpicture}
        ...
        \node[dot, label=below left:{$00$}] (00) at (0, 0) {};
        \node[dot, label=below left:{$01$}] (01) at (0, 1) {};
        \node[dot, label=below left:{$02$}] (02) at (0, 2) {};
        \node[dot, label=below left:{$10$}] (10) at (1, 0) {};
        \node[dot, label=below left:{$11$}] (11) at (1, 1) {};
        \node[dot, label=below left:{$12$}] (12) at (1, 2) {};
        \node[dot, label=below left:{$20$}] (20) at (2, 0) {};
        \node[dot, label=below left:{$21$}] (21) at (2, 1) {};
        \node[dot, label=below left:{$22$}] (22) at (2, 2) {};

        \draw[-]
          (00) edge (01)
          (00) edge[bend right] (02)
          (00) edge (10)
          (00) edge[bend left] (20)
          (01) edge (02)
          (01) edge (11)
          (01) edge[bend left] (21)
          (02) edge (12)
          (02) edge[bend left] (22)
          (10) edge (11)
          (10) edge[bend right] (12)
          (10) edge (20)
          (11) edge (12)
          (11) edge (21)
          (12) edge (22)
          (20) edge (21)
          (20) edge[bend right] (22)
          (21) edge (22)
        ;
        ...
        ;
      \end{tikzpicture}
      \caption{An shift-type automorphism of $H(2, 3)$ (see Lemma
        \ref{lem:hamming-shift-automorphisms}).}
    \end{figure}
    ...
    \begin{figure}[h]
      ...
      \begin{tikzpicture}
        ...
        \node[below of = 10] (10') {};
        \node[left of = 01] (01') {};
        \draw[<->, dashed, thick] (10') edge[bend left, out=130, in=50] (01');
      \end{tikzpicture}
      \caption{A component permutation of $H(2, 3)$ (see Lemma
        \ref{lem:hamming-component-permutation}).}
    \end{figure}
    ...
    \begin{figure}[h]
      ...
      \begin{tikzpicture}
        ...
        \node[below of = 10] (10') {};
        \node[below of = 20] (20') {};
        \draw[<->, dashed, thick] (10') edge (20');

        \node[left of = 01] (01') {};
        \node[left of = 02] (02') {};
        \draw[<->, dashed, thick] (01') edge (02');
      \end{tikzpicture}
      \caption{An automorphism permuting the nonzero elements of each component
        of $H(2, 3)$ (see Lemma \ref{lem:hamming-coefficient-permutation}).}
    \end{figure}
    ...
    \begin{proof}
      ...
      \Sym\( \Z_q \setminus \set{0} \)$ there is a distinct automorphism $\tau_1
    ...
    \begin{defn}[{{\cite[Section~11.1]{godsil}}}]\label{defn:distance-transitive}
    ...
    for example).  The automorphism group of the Hamming graphs is also
    well-known, and given for example in \cite{mirafzal}.  To the best of the
    author's knowledge, the proofs given here are unique.  The construction of
    the automorphism group of $H(d, q)$ follows the outline of \cite{winter}.
...
\chapter{Association Schemes}\label{ch:AS}
  \section{Association Schemes}\label{sec:AS:AS}
    ...
    \subsection{Duality and Characterization}\label{sec:AS:AS:duality}
      ...
      $a_i = \sum_j P_i(j) f_j$ computing $a_i \circ a_j = \delta_{ij} a_i$ and extending
      bilinearly.
  ...
  \section{$P$-Polynomial Schemes}\label{sec:AS:PPS}
    ...
    \begin{defn}[{{\cite[Section~12.3]{godsil}}}]\label{defn:p-polynomial}
    ...
    \begin{proof}
      ...
      From Lemma \ref{lem:drg-mult-closed}, the product of distance matrices
      ...
      $i+1$.  Then by Lemma \ref{lem:drg-mult-restricted},
      $$
  ...
  \section{Automorphisms and Cayley Graphs}
    ...
    \begin{defn}[Cayley Graphs]\label{defn:cayley-graph}
  ...
  \section{Partitions and Translation Schemes}\label{sec:AS:translation}
    ...
    \begin{defn}[Translation Schemes {{\cite[Section~12.10]{godsil}}}]\label{defn:translation-scheme}
      A \textsc{translation scheme} is an association scheme whose
      automorphism group contains a transitive, abelian subgroup.
    \end{defn}

    \begin{lem}[{{\cite[Section~12.10]{godsil}}}]\label{lem:translation-partition}
    ...
    \begin{defn}[Partition Matrix {{\cite[Section~12.7]{godsil}}}]\label{defn:partition-matrix}
    ...
    \begin{defn}[Induced Row Partition {{\cite[Section~12.7]{godsil}}}]\label{defn:induced-row-partition}
...
\chapter{Delsarte's Linear Programming Bound}\label{ch:LP-bound}
  ...
  \section{The LP Bound}\label{sec:LP-bound:LP-bound}
    ...
    feasible solution to the dual problem (Equation \ref{eqn:dlp-dual}) will provide a
    ...
    will begin by introducing a different measure of the distribution of
...
\chapter{Group Theory}
  \section{Group Actions}
    ...
    \begin{defn}[Group Action]\label{defn:group-action}
    ...
    \begin{defn}[Types of Group Actions]\label{defn:group-action-types}
...
\chapter{Notation}
  ...
  \begin{tabular}{Cl}
    ...
    \mathbbm{1} & the indicator function \\
